...
def naive_bayes(train_x, train_y, test_x, test_y, n_fold=10):
    ...
    with open("results.txt", "a") as my_file:
        ...
        my_file.write("[NB] Testing Mean Test Score: " + str(y_hat))
    # with open("classification_reports.txt", "a") as my_file:
        # my_file.write("---[NB]---")
        # my_file.write(classification_report(y_true=test_y, y_pred=y_hat, target_names=[str(i) for i in clf.classes_]))
    ...
    with open("results.txt", "a") as my_file:
        ...
        my_file.write("[NB Isotonic] Testing Mean Test Score: " + str(y_hat))
    # with open("classification_reports.txt", "a") as my_file:
    #    my_file.write("---[NB Isotonic]---")
    ...
    with open("results.txt", "a") as my_file:
        ...
        my_file.write("[NB Sigmoid] Testing Mean Test Score: " + str(y_hat))
    # with open("classification_reports.txt", "a") as my_file:
